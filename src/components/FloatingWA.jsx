  ...
  return (
    <>
      <a href={waLink} target="_blank" rel="noopener noreferrer" aria-label="Chat WhatsApp"
        style={{ position: 'fixed', bottom: 28, right: 28, zIndex: 999, display: 'flex', alignItems: 'center', gap: 10, background: 'linear-gradient(135deg,#25D366,#128C7E)', color: 'white', padding: '14px 22px', borderRadius: 50, boxShadow: '0 4px 20px rgba(37,211,102,0.45)', textDecoration: 'none', fontWeight: 700, fontSize: '0.92rem', animation: 'pulse-wa 2.5s infinite', transition: 'transform 0.3s' }}
      ...
      <style>{`
        @media (max-width: 500px) { .wa-label { display: none; } }
        @keyframes pulse-wa {
