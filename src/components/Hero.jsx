      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, padding: '40px 20px', width: '100%' }}>
        <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
          ...
          <div className="animate-fadeInUp delay-200 hero-image-wrapper" style={{ position: 'relative' }}>
            ...
            <img src="/Logo_Peyek.jpeg" alt="Toko Peyek Listinawati" style={{ width: '100%', height: 'auto', maxHeight: '70vh', objectFit: 'contain', borderRadius: 'var(--radius)', position: 'relative', zIndex: 1, filter: 'drop-shadow(0 20px 40px rgba(0,0,0,0.08))' }} />
